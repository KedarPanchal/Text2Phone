...
public class InitialArguments {
    ...
    @Parameter(names={"-s", "--send", "--send-file", "--send-message"}, description="Sends a file to iPhone address. The first argument is the name of the device the fill will be sent to. The second is the path of the file that will be sent to the device.", arity=2)
